# Portage `app/mcp/` — CRUD bloc v2.5.0 (Phase 4 mission)
...
- Miroir `houetor-mcp/` v2.5.0 : unitaires 29/29, intégration 33/33, scénarios Phase 3 26/26 (preuve du protocole)
